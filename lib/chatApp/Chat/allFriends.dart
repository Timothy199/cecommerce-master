  ...
  void registerNotification() {
    ...
    firebaseMessaging.getToken().then((token) {
      ...
      EcommerceApp.firestore
          ...
          .document(EcommerceApp.sharedPreferences.getString(ChatApp.userUID))
      ...
      onTap: () {
        Route route = MaterialPageRoute(
            builder: (builder) => Chat(
                  ...
                  userID:
                      EcommerceApp.sharedPreferences.getString(ChatApp.userUID),
                ));
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      CircleAvatar(
                        ...
                        backgroundImage:
                            NetworkImage(data.data[EcommerceApp.userAvatarUrl]),
                      ),
                    ],
                  ),
                ),
...
//                                  .collection(EcommerceApp.sharedPreferences
